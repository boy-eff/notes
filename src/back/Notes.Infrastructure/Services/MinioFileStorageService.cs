...
public class MinioFileStorageService : IFileStorageService
{
    ...
    {
        var persistFileName = $"{Path.GetFileNameWithoutExtension(fileName)}_{DateTimeOffset.Now.ToUnixTimeMilliseconds()}{Path.GetExtension(fileName)}";
        var putObjectArgs = new PutObjectArgs()
            .WithBucket(_bucketName)
            .WithObject(persistFileName)
